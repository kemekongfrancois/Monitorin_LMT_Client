...
public class WSClientMonitoring {
    ...
    public String hello(@WebParam(name = "name") String txt) {
        ...
        //arreterLeScheduler();
        return "Hello je suis le WSClient " + txt + " ! version= 1.05 IP="+BeanClient.ADRESSE_MACHINE+" Port:"+BeanClient.PORT_MACHINE+" Nom:"+BeanClient.NOM_MACHINE+" OS:"+BeanClient.OS_MACHINE;
    }
